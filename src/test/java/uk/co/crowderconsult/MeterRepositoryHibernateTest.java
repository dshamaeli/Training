...
public class MeterRepositoryHibernateTest {
    ...
    public void setUp() throws SQLException {
        ...
        String insertMeter2 = "insert into meter (meter_id,name,install_date,is_active,measurement_data_type,meter_type_id) values (753,'Quality Area 1 Meter', to_date('25-DEC-2017 5:56 PM', 'dd-mon-yyyy hh:mi PM'),'Y','FLOW',2)";//NON-NLS
