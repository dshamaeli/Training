...
public class Meter extends MeterType {
	 ...
	 * 
	 * @param id
	 *            Unique number that identifies the meter
	 * @param typeName
	 *            type of this meter
	 * 
	 * @param maxSize
	 ...
	 * @param active
	 *            Shows whether the meter is active or not
	 * @param measurementDataType
	 *            data type that the meter measures
	 * @see MeterType
	 * @see MeasurementDataType
	 */
	public Meter(int id, String typeName, Double maxSize, Double maxFlow, Double maxPressure, String name,
			Date installDate, Boolean active, MeasurementDataType measurementDataType) {
		super(typeName, maxSize, maxFlow, maxPressure);
		this.id = id;
		this.name = name;
